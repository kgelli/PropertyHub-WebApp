...
<head>
    <meta charset="utf-8">
    <title>NebulaNest Delete Form</title>
...
<body>
    <div class="wrapper">
        ...
        <form method="post" action="delete_card.php" enctype="multipart/form-data">
            <div class="field">
            ...
            <div class="signup-link">
                Back to Dashboard? <a href="seller_dashboard.php">Dashboard</a>
            </div>
