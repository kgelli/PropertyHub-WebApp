...
$username = "kgelli2"; // change to panther id if using codd
$password = "kgelli2"; // change to panther id if using codd
$dbname = "kgelli2"; // change to panther id if using codd
